...
describe("profile data", () => {
  ...
  expectedPublications.forEach((expectedPublication, index) => {
    it(`preserves exact publication ${index + 1}: ${expectedPublication.title}`, () => {
      expect(publications[index]).toEqual(expectedPublication);
    });
  });

  it("preserves the exact project collection", () => {
  ...
  it("preserves the exact education collection", () => {
  ...
  it("preserves the exact contact collection", () => {
  ...
  it("preserves the exact footer tagline", () => {
    expect(footerTagline).toBe(
